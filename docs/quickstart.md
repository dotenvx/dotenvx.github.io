...
$ curl -sfS https://dotenvx.sh | sh
    {% endcapture %}
    {% include components/design-codeblock.html value=install_commands copy_text="curl -sfS https://dotenvx.sh | sh" format="cli" %}
    {% endcapture %}
...
Hello Production
    {% endcapture %}
    {% include components/design-codeblock.html value=production_run copy_text="dotenvx run -- node index.js" format="cli" %}
