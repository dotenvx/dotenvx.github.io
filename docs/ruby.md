...
$ gem install dotenvx
    {% endcapture %}
    {% include components/design-codeblock.html value=install_commands copy_text="gem install dotenvx" %}
...
Hello Secret
    {% endcapture %}
    {% include components/design-codeblock.html value=run_commands copy_text="ruby app.rb" %}
...
puts "Hello #{ENV['HELLO']}"
    {% endcapture %}
    {% include components/design-codeblock.html value=production_app %}
...
Hello Production
    {% endcapture %}
    {% include components/design-codeblock.html value=production_run copy_text="ruby app.rb" %}
