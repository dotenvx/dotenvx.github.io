...
<section class="radar-section">
  <div class="armor-shell design-prose">
    ...
    <h2 class="design-list-title">Your Privacy Rights</h2>
    <p class="design-paragraph">Depending on your location and applicable law, you may have rights regarding your personal data, including the right to access, correct, delete, export, or restrict certain uses of your information.</p>
    <p class="design-paragraph">You may also have the right to object to certain processing activities or lodge a complaint with your local data protection authority.</p>
    <p class="design-paragraph">To exercise these rights, contact <a class="design-link" href="mailto:support@dotenvx.com">support@dotenvx.com</a>.</p>
