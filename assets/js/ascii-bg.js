(() => {
  ...
  const fragSrc = [
    ...
    "  vec3 darkSequin = vec3(0.024, 0.018, 0.012);",
    ...
    "  vec3 ambient = mix(darkSequin, vec3(0.054, 0.038, 0.024), facing * 0.6);",
    "  vec3 sequinColor = ambient;",
    "  float sheenAmount = pow(max(facing, 0.0), 3.0) * 0.22 * reflVar;",
    ...
    "  sequinColor += copperMid * flashLow * 0.48;",
    "  sequinColor += amberFlash * flashHigh * 0.74;",
    "  sequinColor += hotGold * flashPeak * 1.18;",
    "  sequinColor += copperMid * bevel * facing * 0.22;",
    "  sequinColor += amberFlash * churchEdge * 0.13;",
    ...
    "  float scaleX = mix(1.86, 1.10, responsive);",
    "  float scaleY = mix(1.72, 1.02, responsive);",
    "  float liftY = mix(-0.24, -0.01, responsive);",
    "  p.x *= scaleX;",
    "  p.y *= scaleY;",
    "  p.y += liftY;",
    "",
