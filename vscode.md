...
<div class="flex flex-col gap-6 mx-auto w-fit text-center items-center mt-40">
  <div class="flex flex-col gap-2">
    ...
    <a href="https://marketplace.visualstudio.com/items?itemName=dotenv.dotenv-vscode"><u>Dotenv Official on Visual Studio Marketplace</u></a>
  </div>

  <a class="btn-outline w-fit" href="https://marketplace.visualstudio.com/items?itemName=dotenv.dotenv-vscode">Continue</a>
