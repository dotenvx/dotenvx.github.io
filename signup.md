...
<div class="flex flex-col gap-6 mx-auto w-fit text-center items-center mt-40">
  <div class="flex flex-col gap-2">
    ...
    <a href="https://armor.dotenvx.com/signup"><u>armor.dotenvx.com/signup</u></a>
  </div>

  <a class="btn-outline w-fit" href="https://armor.dotenvx.com/signup">Continue</a>
...
<script>
  ...
  interval = setInterval(function() {
    ...
    if (count <= 0) {
      window.location.replace("https://armor.dotenvx.com/signup")
