...
<section class="radar-hero legal-hero">
  <div class="radar-shell legal-shell">
    <p class="radar-kicker">Legal</p>
    <h1 class="radar-title">Terms of Service</h1>
  </div>
</section>

<section class="radar-section">
  <div class="radar-shell legal-shell legal-prose">
