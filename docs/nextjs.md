...
npm install @dotenvx/next-env
    {% endcapture %}
    {% include components/design-codeblock.html value=install_commands copy_text=install_commands_copy %}
    ...
    {% capture next_override %}
{
  "overrides": {
    ...
    {% endcapture %}
    {% include components/design-codeblock.html value=next_override %}
    <p class="design-paragraph">Apply it:</p>
    {% capture next_install %}
$ npm install
    {% endcapture %}
    {% include components/design-codeblock.html value=next_install copy_text="npm install" %}
...
◈ encrypted (.env)
    {% endcapture %}
    {% include components/design-codeblock.html value=encrypt_commands copy_text="npx dotenvx encrypt" %}
...
$ npx next dev
    {% endcapture %}
    {% include components/design-codeblock.html value=run_commands copy_text="npx next dev" %}
...
{"DOTENV_PUBLIC_KEY":"0220d830351410598be484f43a7b07097e09851f50426832876e8b5815a1752990","DOTENV_PRIVATE_KEY":"b37dbad0e00206f31486c4f44f8cc7abf2f1be96d5ba352eb791122b5e131bbf"}
    {% endcapture %}
    {% include components/design-codeblock.html value=keypair_commands copy_text="npx dotenvx keypair" class="design-codeblock--nowrap" %}
...
npx next start
    {% endcapture %}
    {% include components/design-codeblock.html value=deploy_commands copy_text=deploy_commands_copy %}
...
◈ encrypted (.env.production)
    {% endcapture %}
    {% include components/design-codeblock.html value=production_encrypt copy_text="npx dotenvx encrypt -f .env.production" %}
